...
class VisualizationService:
    ...
    def plot_time_series(
        ...
        try:
            ...
            logger.warning(f"Model not found for visualization: series_id='{series_id}', version='{version}'")
        ...
        ax.set_title(f'Time Series: {series_id} (Version: {used_version})', fontsize=14, fontweight='bold')
        ax.legend(loc='best')
        ...
        logger.info(f"Generated plot for series_id='{series_id}', version='{used_version}'")
